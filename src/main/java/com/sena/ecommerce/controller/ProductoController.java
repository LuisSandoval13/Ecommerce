...
import com.sena.ecommerce.service.UploadFileServices;
...
public class ProductoController {
	...
	// Metodo para el formulario para la edicion de productos

	@GetMapping("/edit/{id}")
	public String edit(@PathVariable Integer id, Model model) {
		Producto p = new Producto();

		// Nos retorna la busqueda de un objeto de tipo producto con el tipo Id 
	...
	public String update(Producto producto, @RequestParam("img") MultipartFile file) throws IOException {
		LOGGER.info("Busqueda de producto a actualizar en la DB{}", producto);
		Producto p = new Producto();
